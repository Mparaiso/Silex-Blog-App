...
$app['config.server'] = getenv('MONGOBLOG_SERVER')?getenv('MONGOBLOG_SERVER'):"localhost";
$app['config.database'] = getenv("MONGOBLOG_DATABASE")?getenv("MONGOBLOG_DATABASE"):"mongoblog";
