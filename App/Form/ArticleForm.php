...
namespace App\Form{
  ...
  use App\Form\DataTransformer\MetadataObjectToMetadataArrayTransformer;
	...
	class ArticleForm extends AbstractType{
      ...
      $metadataTransformer = new MetadataObjectToMetadataArrayTransformer();
      ...
      $builder->add(
        $builder->create('metadatas','collection',
          ...
          )->prependNormTransformer($metadataTransformer)
        );
      $builder->add(
        #WARNING !
